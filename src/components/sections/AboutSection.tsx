...
const highlights = [
  {
    ...
    gradient: 'linear-gradient(135deg, hsl(203 100% 59% / 0.12), hsl(162 100% 72% / 0.08))',
  ...
  },
  {
    ...
    gradient: 'linear-gradient(135deg, hsl(279 82% 54% / 0.12), hsl(203 100% 59% / 0.08))',
  ...
  },
  {
    ...
    gradient: 'linear-gradient(135deg, hsl(162 100% 72% / 0.12), hsl(160 70% 45% / 0.08))',
    iconColor: 'text-info',
  },
  {
    icon: Users,
    ...
    gradient: 'linear-gradient(135deg, hsl(279 82% 54% / 0.12), hsl(190 100% 79% / 0.08))',
    iconColor: 'text-accent',
  },
];
