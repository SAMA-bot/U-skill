...
const modules = [
  ...
  },
  {
    ...
    gradient: 'linear-gradient(135deg, hsl(var(--brand-c)), hsl(var(--success)))',
    glowColor: 'hsl(var(--brand-c) / 0.1)',
  },
  {
    ...
    gradient: 'linear-gradient(135deg, hsl(var(--accent)), hsl(var(--brand-d)))',
    glowColor: 'hsl(var(--accent) / 0.1)',
  },
];
